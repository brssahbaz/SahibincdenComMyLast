...
public class ElementHelper {
    ...
    public WebElement clickElementWithTextContainWebElement(By locator, String text) {
        int i = 0;
        boolean check = false;
        findElement(locator);
    ...
    public WebElement clickElementWithTextEqualsWebElement(By locator, String text) {
        int i = 0;
        boolean check = false;
        findElement(locator);
        WebElement foundWebElement = null;
    ...
    public void scrollDown() {
        ...
        scroll.addAction(finger.createPointerMove(Duration.ofMillis(200), PointerInput.Origin.viewport(), endx, endY));
